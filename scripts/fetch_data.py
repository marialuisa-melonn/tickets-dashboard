  ...
  # Credenciales desde variables de entorno (se configuran en GitHub, no aquí)
  ...
  GROUP BY sbs.name
  HAVING COUNT(DISTINCT so.id) > 0 OR COUNT(DISTINCT t_orb.id) > 0 OR COUNT(DISTINCT ht.ticket_id) > 0
